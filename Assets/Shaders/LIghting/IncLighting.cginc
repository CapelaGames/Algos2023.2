...
fixed4 frag (v2f i) : SV_Target
{
    ...
    float3 L = normalize(UnityWorldSpaceLightDir(i.worldPosition)); //_WorldSpaceLightPos0.xyz;
    ...
    specularLight = pow(specularLight, specularExponent) * _Gloss * attenuation; // Pow(X,N) = X ^ N
